...
class SyncNetModel(nn.Module):
    def __init__(self, nOut=1024, stride=1):
        ...
        self.netcnnaud = nn.Sequential(
            ...
            nn.Conv2d(256, 512, kernel_size=(5, 4),
                      padding=(0, 0), stride=(1, stride)),
            nn.BatchNorm2d(512),
            nn.ReLU(),
        )
    ...
    def forward_aud(self, x):
        ...
        x1, mfcc_lengths = self.mfcc_layer(
            x, [x.size()[1]]*x.size()[0])      # Do mfcc
    ...
    def forward(self, aud, vid):
        ...
        out_v1, out_v2 = self.forward_aud(vid)
